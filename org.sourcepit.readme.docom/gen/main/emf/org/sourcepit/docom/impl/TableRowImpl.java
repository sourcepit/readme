 ...
 * <ul>
 * <li>{@link org.sourcepit.docom.impl.TableRowImpl#getCells <em>Cells</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableRowImpl extends MinimalEObjectImpl.Container implements TableRow
{
   ...
   {
      return DocOMPackage.Literals.TABLE_ROW;
   }
   ...
   public EList<TableCell> getCells()
   {
      if (cells == null)
      {
         cells = new EObjectContainmentWithInverseEList<TableCell>(TableCell.class, this,
            DocOMPackage.TABLE_ROW__CELLS, DocOMPackage.TABLE_CELL__ROW);
      }
      return cells;
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         case DocOMPackage.TABLE_ROW__CELLS :
